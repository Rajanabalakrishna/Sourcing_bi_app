...
class PlanService {
  ...
  Future<List<VillageVisitPlan>> fetchVisitPlans() async {
    ...
    final url = Uri.parse('$baseUrl/village-visit-plans/?user_id=$userId');
  ...
  /// Submit meeting record (person met or not met)
